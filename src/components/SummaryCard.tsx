          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="space-y-1 p-4 rounded-lg border bg-card text-card-foreground shadow-sm">
              ...
              <p className="text-2xl font-bold">
                {totalLoad} <span className="text-sm font-medium text-muted-foreground">W</span>
              </p>
            </div>
          ...
          <div className="rounded-lg border bg-muted/20 overflow-hidden">
            <div className="grid grid-cols-2 divide-x border-b last:border-0 md:border-border">
              <div className="p-4 space-y-1">
                ...
                <div>
                  <p className="text-lg font-bold">
                    {dailyKWh.toFixed(2)} <span className="text-xs font-medium text-muted-foreground">kWh</span>
                  </p>
              ...
              <div className="p-4 space-y-1">
                ...
                <div>
                  <p className="text-lg font-bold">
                    {monthlyKWh.toFixed(2)} <span className="text-xs font-medium text-muted-foreground">kWh</span>
                  </p>
                  <p className="text-sm font-medium text-primary">
