...
export function getInvestmentInsight(
  ...
  if (totalContribution <= 0 || finalBalance <= 0) {
    return { icon: "lightbulb", text: "Enter your strategy to see what your money can become.", tone: "neutral" };
  }
...
export function getLoanInsight(
  ...
  if (amount <= 0 || totalInterest <= 0) {
    return { icon: "landmark", text: "Enter your loan details to see the true cost of borrowing.", tone: "neutral" };
  }
...
export function getFDRInsight(
  ...
  if (principal <= 0 || maturityAmount <= principal) {
    return { icon: "landmark", text: "Enter your deposit details to see what your fixed deposit will earn.", tone: "neutral" };
  }
...
export function getDPSInsight(
  ...
  if (totalPrincipal <= 0 || netInterest <= 0) {
    return { icon: "piggy-bank", text: "Set your monthly installment to see how your savings grow over time.", tone: "neutral" };
  }
...
export function getVehicleSavingsInsight(
  ...
  if (savings <= 0 || distance <= 0) {
    return { icon: "zap", text: "Compare EV vs Fuel costs above to see potential savings.", tone: "neutral" };
  }
